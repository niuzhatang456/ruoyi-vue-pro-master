...
CREATE TABLE IF NOT EXISTS "attendance_daily_report" (
    ...
    "clock_in_result" varchar(32) DEFAULT NULL,
    "clock_in_location" varchar(200) DEFAULT NULL,
    "clock_in_remark" varchar(500) DEFAULT NULL,
    "clock_out_time" timestamp DEFAULT NULL,
    "clock_out_result" varchar(32) DEFAULT NULL,
    "clock_out_location" varchar(200) DEFAULT NULL,
    "clock_out_remark" varchar(500) DEFAULT NULL,
    "creator" varchar(64) DEFAULT '',
    "create_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updater" varchar(64) DEFAULT '',
    "update_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
