...
CREATE TABLE IF NOT EXISTS `jijian_business_trip` (
  ...
  `applicant_name`        varchar(64)   CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL          COMMENT '申请人姓名',
  `employee_no`           varchar(32)   CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '员工编号',
  `trip_reason`           varchar(256)  CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '出差事由',
  `departure_place`       varchar(128)  CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '出发地',
  `destination`           varchar(128)  CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '目的地',
  `start_date`            datetime      NULL DEFAULT NULL                           COMMENT '出差开始日期',
  `end_date`              datetime      NULL DEFAULT NULL                           COMMENT '出差结束日期',
  `trip_days`             decimal(8,2)  NULL DEFAULT NULL                           COMMENT '出差天数',
  `trip_personnel`        varchar(500)  CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '出差人员',
  `is_outside`            bit(1)        NOT NULL DEFAULT b'0'                       COMMENT '是否出义',
  `outside_location`      varchar(128)  CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '出义具体地点',
  `leave_type`            varchar(32)   CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'deprecated：旧请假类型',
  `leave_reason`          varchar(256)  CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'deprecated：旧出差事由',
  `start_time`            datetime      NULL DEFAULT NULL                           COMMENT 'deprecated：旧开始时间',
  `end_time`              datetime      NULL DEFAULT NULL                           COMMENT 'deprecated：旧结束时间',
  `leave_days`            decimal(5,1)  NULL DEFAULT NULL                           COMMENT 'deprecated：旧出差天数',
